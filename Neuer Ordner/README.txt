...
This is the readme for Sun and Moon, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. SunAndMoon) > Ok.
...
- To run the project find SunAndMoon.java (which will be in under src/main/java/sunandmoon) and right click > Run 'SunAndMoon'
